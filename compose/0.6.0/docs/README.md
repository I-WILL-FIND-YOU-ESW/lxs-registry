...
The page opens on a chooser with three on-ramps — the CLI, the IDE (the
composer below), and an AI agent (the Ecosphere Assistant). They are numbered
as a guide and every panel cross-links to the next, but you can switch at any
